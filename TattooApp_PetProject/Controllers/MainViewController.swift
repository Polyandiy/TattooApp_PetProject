...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "PriceNavID")
        case 2:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "RecommendNavID")
        case 3:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "RecordingVCID")
        case 4:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "TattooIdeasVCID")
        case 5:
